...
#define HAL_KEY_LONG 0x04  // Long Press
#define HAL_KEY_SHORT 0x80 // Short Press

#define HAL_KEY_SW_6 0x20  // Button S1 if available
#define HAL_KEY_SW_7 0x40  // Button S2 if available
#define HAL_CHARGE   0x80  // Connect with battery charge state input port
...
extern bool HalKeyPressing ( uint8 keys );
