/**************************************************************************************************
  Filename:       GloveCentral.h
  Revised:        $Date: 2011-03-03 15:46:41 -0800 (Thu, 03 Mar 2011) $
  Revision:       $Revision: 12 $

  Description:    This file contains the TJGQ Glove bluetooth device (Central)
 ...
 */
extern void GloveCentral_Init( uint8 task_id );

/*
 * Task Event Processor for the BLE Application
 */
extern uint16 GloveCentral_ProcessEvent( uint8 task_id, uint16 events );
